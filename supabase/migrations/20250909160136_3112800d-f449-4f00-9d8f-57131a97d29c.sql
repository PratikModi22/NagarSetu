...
-- Insert the admin records for the requested emails
INSERT INTO public.admins (auth_id, name, email, role) 
VALUES 
  ('58e6e881-e4c3-4fb7-9704-7bd564cc4b8f', 'Lord', 'lordmodizz@gmail.com', 'admin')
ON CONFLICT (auth_id) DO NOTHING;

-- Note: pratikgmodi22@gmail.com will be added once they successfully sign up